...
export const calcBondDetails = createAsyncThunk(
  ...
  async ({ bond, value, provider, networkID }: ICalcBondDetailsAsyncThunk, { dispatch }): Promise<IBondDetails> => {
    ...
    try {
      ...
      // let set1 = ((marketPrice ?? 0) * Math.pow(10, 18) - Number(bondPrice.toString()))
      // let set2 = Number(bondPrice.toString())
      ...
      // ### 输出：价格
      // console.dir('-- 合约方法：bondPriceInUSD() --s')
      // console.dir('处理18位：' + set1)
      // console.dir('合约返回：' + set2)
      // console.dir(bondDiscount)
      // console.dir('----n')
